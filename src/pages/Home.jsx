...
const Home = () => {
  return (
    <div
      ...
      id="home"
    >
      <div className="w-max-[100vw] text-center relative w-full h-screen flex flex-col  text-black max-sm:h-[150dvh] max-sm:-mb-[200px]">
        <div className=" top-0 left-0 right-0 w-max-[100vw] h-[50dvh] max-sm:h-[25%] z-10 ">
          <div className="relative w-full h-full background-image">
            <div className="absolute w-full h-full top-0 bottom-0  max-sm:bg-white "></div>
            <img
              src={Wallpaper2}
              className="w-full h-[50dvh] object-cover  shadow-inner-[100px] absolute opacity-70 max-sm:h-[100%]"
            />
            <div className="absolute bottom-10 max-sm:bottom-20 z-[100] xl:left-10">
              <div
        ...
        <div className="z-0 flex justify-center items-center w-full h-[50dvh] max-sm:flex-col-reverse max-sm:h-[50%] ">
          <div className="w-2/5 flex justify-center items-center max-sm:w-full max-sm:h-[50%]">
            <img
              src={Photo1}
              className="w-[500px] rounded-3xl shadow-xl max-sm:w-[80%]"
              data-aos-delay="500"
              data-aos-easing="linear"
              data-aos="fade-right"
            />
        ...
        <div className="flex flex-col xl:justify-center items-center z-10  h-full">
          <div className="w-fit pb-10">
            <h1
              data-aos-delay="300"
              data-aos="zoom-out"
              className="font-extrabold text-5xl max-sm:text-3xl  text-transparent bg-clip-text bg-gradient-to-r from-sky-600 to-blue-200"
            >
              What is IOE Hub ?
            </h1>
          </div>
